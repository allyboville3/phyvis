...
#' @param ladderize logical (default `TRUE`). Should the tree be re-organized to have a 'ladder' aspect?
...
#' @param hang numeric The fraction of the tree plot height by which labels should hangbelow the rest of the plot. A negative value will cause the labels to hang down from 0. Thisparameter only work with the 'dendrogram' layout for 'hclust' like class, default is 0.1.
#' @return tree
...
#' @seealso [geom_tree()]
#' @references 1. G Yu, TTY Lam, H Zhu, Y Guan (2018). Two methods for mapping and visualizing associated dataon phylogeny using ggtree. Molecular Biology and Evolution, 35(2):3041-3043.<https://doi.org/10.1093/molbev/msy194> 2. G Yu, DK Smith, H Zhu, Y Guan, TTY Lam (2017). ggtree: an R package for  visualization and annotation of phylogenetic trees with their covariates and other associated data. Methods in Ecology and Evolution, 8(1):28-36. <https://doi.org/10.1111/2041-210X.12628> For more information, please refer to *Data Integration, Manipulation and Visualization of Phylogenetic Trees* <http://yulab-smu.top/treedata-book/index.html> by Guangchuang Yu.
#' @examples require(ape)
#' tr <- rtree(10)
#' ggtree(tr)
ggtree <- function(tr,
                   mapping        = NULL,
