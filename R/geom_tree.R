...
#' @param layout one of 'rectangular', 'dendrogram', 'slanted', 'ellipse', 'roundrect', 'fan', 'circular', 'inward_circular', 'radial', 'equal_angle', 'daylight' or 'ape'
#' @param multiPhylo logical, whether input data contains multiple phylo class, defaults to "FALSE".
#' @param continuous character, continuous transition for selected aesthethic ('size' or 'color'('colour')). It should be one of 'color' (or 'colour'), 'size', 'all' and 'none', default is 'none'
...
#' @param ... additional parameter some dot arguments: \itemize{   \item \code{nsplit} integer, the number of branch blocks divided when 'continuous' is not "none", default is 200. }
#' @return tree layer
#' @section Aesthetics:
